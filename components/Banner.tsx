...
function Banner({ netflixOriginals }: Props) {
  ...
  return (
    ...
    lg:justify-end lg:pb-12">
        ...
        <p className="max-w-xs text-sm text-shadow-md md:max-w-lg md:text-lg lg:max-w-2xl
        lg:text-2xl">
            {movie?.overview}
        </p>

        <div className="flex space-x-3">
            <button className="bannerBtn bg-slate-50 text-black">
                <FaPlay 
            ...
            >
                Watch info <InformationCircleIcon className="h-5 w-5 md:h-7 md:w-8" />
            </button>
        </div>
    </div>
  )
