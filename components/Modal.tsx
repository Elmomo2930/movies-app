    ...
    useEffect(() => {
        ...
        async function fetchMovie() {
          ...
          process.env.NEXT_API_KEY
            ...
            if(date?.videos) {
                const index = date.videos.results.findIndex((element: Element) => 
                element.type === "Trailer")
                setTrailer(date?.videos.results[index]?.key)
            }
         ...
         <div>
          ...
          px-10'>
              <div className='flex space-x-2'>
                  <button
                   className='flex items-center gap-x-2 rounded bg-yellow-50 px-8
             ...
             >
                 ...
                 >
                     ...
                     <div
                      ...
                      border border-white/30 px-1.4 text-sm'
                     >
                         HDFULL
                     </div>
                 </div>
